...
function toggleMobileMenu() {
    ...
    e ? (t[0].style.transform = "none", t[1].style.opacity = "1", t[2].style.transform = "none") : (t[0].style.transform = "rotate(45deg) translate(4px, 4px)", t[1].style.opacity = "0", t[2].style.transform = "rotate(-45deg) translate(4px, -4px)")
}
