const navToggle = document.querySelector(".nav-toggle"),
    ...
    projectsData = [{
        ...
        projects: [
            ...
            },
            {
                ...
                description: "An Optional Texture Pack for \"Toggle Night Vision\" to remove the text at the top middle.",
            ...
            {
                title: "Déesse UI Pack",
                description: "An UI resource pack that adds new features, tweaks and UI designs to make your Minecraft gameplay better! (Created by ItzRiyo with my code contributions)",
            ...
            },
            {
                ...
                description: "Reposition the subtitles like Minecraft Java Edition (for Minecraft Preview Currently)",
    ...
    archivedData = [{
        ...
        projects: [{
            ...
            description: "An Android app that allows you map volume keys to other keystrokes that minecraft can use like f5 for quick thirdperson view."
        }, {
            title: "MinecraftMod (Modded Minecraft Bedrock APK)",
            description: "A Modification of the Minecraft that has custom ui, items, entites and more features that you are not present in the base game.",
            ...
            description: "A texture pack that brings the Windows 11 desktop to Minecraft. Useless",
            link: "https://www.youtube.com/watch?v=3y5gfQnlmiw"
        }, {
            title: "MinecraftMod App (Android App)",
            description: "An app that contains utilities for MinecaftMod built with OreUi design.",
...
function createProjectCard(e) {
    ...
    if (e.image) {
        const n = createElement("img", "project-image", {
            src: e.image,
            alt: e.title,
            loading: "lazy"
        });
    ...
    if (i.textContent = e.description, n.appendChild(i), e.link) {
        const t = createElement("a", "project-link", {
            href: e.link,
            target: "_blank",
            rel: "noopener"
        });
        t.textContent = "View", n.appendChild(t)
    }
...
function createSection(e) {
    ...
    return e.projects.forEach((e => {
        i.appendChild(createProjectCard(e))
    })), {
        section: t,
        grid: i
    }
...
function initTheme() {
    "light" === localStorage.getItem("theme") && body.classList.add("light-mode")
}
...
function initProjects() {
    const e = document.getElementById("projects"),
        t = document.getElementById("archived"),
        {
            section: n,
            grid: a
        } = createSection(projectsData[0]);
    e.appendChild(n), e.appendChild(a);
    const {
        section: i,
        grid: o
    } = createSection(archivedData[0]);
...
document.addEventListener("click", (e => {
    ...
    e.addEventListener("click", (function (e) {
        ...
        t && (t.scrollIntoView({
            behavior: "smooth",
            block: "start"
        }), window.innerWidth <= 767 && toggleMobileMenu())
    }))
}));
const warning = document.getElementById("devtools-warning");

function showWarning() {
    warning.style.display = "block", setTimeout((() => {
...
document.addEventListener("keydown", (function (e) {
    ...
    e.preventDefault(), showWarning(), reloadPage()
}));
